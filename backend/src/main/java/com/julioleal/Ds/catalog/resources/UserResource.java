...
import com.julioleal.Ds.catalog.services.UserService;
...
public class UserResource {
	...
	@GetMapping
	public ResponseEntity<Page<UserDTO>> findAll(Pageable pageble) {
		Page<UserDTO> list = service.findAllPaged(pageble);
